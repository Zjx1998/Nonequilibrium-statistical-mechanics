...
subplot(1, 2, 2)
hold on;
plot(noise_sz1, epr_mean2, '-pg', 'LineWidth', 2, 'markersize',10);
plot(noise_sz1, epr_var2, '-dr','LineWidth', 2, 'markersize',10);
